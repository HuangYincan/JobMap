#!/usr/bin/env bash
# boss-agent · fault-recovery entry: wait for the shared API to come back, then
# resume an interrupted batch from its recorded state (idempotent, safe to re-run).
#
