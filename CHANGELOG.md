...
- Home lazy-loads `MapShell` (`next/dynamic`, `ssr: false`). Rail panels (detail / JD / auth / Profile / Recent / Saved / Layers) are split the same way inside the shell. See `tech/12-bundle-notes.md`.
