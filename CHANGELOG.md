...
- Shared `searchPublicCatalog` helper for those routes. District filter still prefers address text and falls back to coarse Hangzhou boxes when the address names no district.
