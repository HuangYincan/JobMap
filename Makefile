...
help: ## Show currently supported commands
	...
	@printf '%s\n' '  make geocode-sites     Apply real office coords to city-list drops, city-scoped (needs AMAP_WEB_KEY; --dry-run prints the plan)'
...
geocode-sites: ## Real office coords for city-list drops, city-scoped (AMAP_WEB_KEY; --dry-run prints the plan)
