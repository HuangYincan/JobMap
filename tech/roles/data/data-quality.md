...
- **剩余 null 清单**:首轮 31 站无地址可回填(清单:`qqj-中际旭创-site-上海/北京`、`qqj-临界点-site-深圳/北京`、`qqj-启元机器人-site-上海`、`qqj-圣邦微电子-site-厦门`、`qqj-时代共赢私募基金-site`、`qqj-沛睿微电子-site-苏州`、`qqj-源件星球-site`、`qqj-神州税道-site`、`qqj-箭元科技-site`、`qqj-络明芯微电子-site`、`qqj-联合电子-site-重庆`、`qqj-艾飞智控-site`、`qqj-荣盛集团-site-苏州`、`qqj-语核科技-site`、`qqj-逆矩阵-site`、`qqj-量智开物-site`、`qqj-靖戈量化-site`、`qqj-首形科技-site`、`qq-九江银行-site-hq`、`qq-北京市各级机关-site-hq`、`embj-1X Technologies-site`、`embj-AIM Intelligent Machines-site`、`embj-Amazon Robotics-site`、`embj-Apptronik-site`、`embj-Boston Dynamics-site`、`embj-Cruise-site`、`embj-Grit Ventures-site`、`embj-HTX-site`、`embj-Tactus-site`);**二轮再查后其中 18 站已回填(见下节),最终剩余 13 站**——`qqj-中际旭创-site-北京`、`qqj-临界点-site-深圳`、`qqj-临界点-site-北京`、`qqj-圣邦微电子-site-厦门`、`qqj-时代共赢私募基金-site`、`qqj-沛睿微电子-site-苏州`、`qqj-源件星球-site`、`qqj-逆矩阵-site`、`qqj-量智开物-site`、`qqj-靖戈量化-site`、`qq-北京市各级机关-site-hq`、`embj-AIM Intelligent Machines-site`、`embj-Grit Ventures-site`。
...
### 二轮再查(2026-08-22,`fix/address-backfill-r2`,w4)

首轮 31 个 null 站点由 4 个再查 subagent 换渠道/换关键词第二轮检索,命中 **18 个地址**(产物 `parallel-sessions/20260821-boss-address-first/results/null-01..04.json`,主仓库只读)。二轮渠道含:360 搜索(so.com,工商记录摘要)、搜狗微信(官方公众号活动通知/招聘简章)、官网深层页(联系页/页脚/FAQ/招聘页)、Ashby ATS(posting-api 结构化地址字段)、维基百科信息框、OSM Nominatim 地址存在性验证、SEC 备案、MapQuest/D&B/商会名录等目录源。

- **回填 18 站**(沿用 w2 聚合与 city 提取规则;`site_id` 全部精确命中 `city-only-list.json`,0 条需去掉 `-<城市>` 后缀回退):`qqj-中际旭创-site-上海`(工商注册地址)、`qqj-启元机器人-site-上海`(张江机器人谷)、`qqj-神州税道-site`(公众号活动通知多源一致)、`qqj-箭元科技-site`(亦城科技中心,BOSS/公众号/猎聘多源)、`qqj-络明芯微电子-site`(取厦门主体注册地址)、`qqj-联合电子-site-重庆`(注册地址多源)、`qqj-艾飞智控-site`(深圳总部三源一致)、`qqj-荣盛集团-site-苏州`(圣汇装备招聘简章)、`qqj-语核科技-site`(官网 langcore.cn)、`qqj-首形科技-site`(爱企查上海注册主体)、`qq-九江银行-site-hq`(维基百科总部)、`embj-1X Technologies-site`(Ashby ATS)、`embj-Amazon Robotics-site`(9 源一致 North Reading 总部)、`embj-Apptronik-site`(5+ 源 Austin 总部)、`embj-Boston Dynamics-site`(官网 Terms + 13 目录源)、`embj-Cruise-site`(4+ 源 333 Brannan St)、`embj-HTX-site`(维基百科信息框 + OSM 验证)、`embj-Tactus-site`(LinkedIn HQ + OSM 验证)。
- **city 提取**(地址→单城市全称):11 站由脏值/缺失修正——神州税道→上海市、箭元科技→北京市、络明芯→厦门市、艾飞智控→深圳市、语核科技→上海市、首形科技→上海市、Amazon Robotics→North Reading, MA、Apptronik→Austin, TX、Boston Dynamics→Waltham, MA、Cruise→San Francisco, CA、Tactus→Fremont, CA;其余 7 站原 city 与提取一致不变。`location` 已含 lng/lat 的 4 站(中际旭创-上海/启元机器人-上海/联合电子-重庆/荣盛集团-苏州)保留坐标仅追加 address。
- **⚠️ Tactus(`embj-Tactus-site`)疑错配需人工复核**:检索所得地址为 Fremont, CA(LinkedIn 公司页 HQ),与数据行 city(Irvine, CA)不符;tactus.com(Tactus Technology)连接失败、careerUrl 指向 career.calvin.edu(Calvin University 职业中心),原抓取疑似错配——若该站点实体非 Tactus Technology 则地址不适用。已按规则回填地址、city 提取为 Fremont, CA,标注待人工复核。
- **剩余 null 13 站**:见上节「剩余 null 清单」末段(中际旭创-北京、临界点-深圳/北京、圣邦微电子-厦门、时代共赢、沛睿-苏州、源件星球、逆矩阵、量智开物、靖戈量化、北京市各级机关-hq、AIM Intelligent Machines、Grit Ventures)。
...
### 2026-08-27 续跑:法律实体词解锁 16 站(grader 扩容)

上节区域前缀修复后,实测剩余 5 城中心钉站中「有真实办公 POI 但被 grader 拒」的一类是
**法律实体词后缀**:帆软软件有限公司(南京运营中心)/ 中信银行南京分行 / XX电子科技有限公司。
`QUALIFIER_SUFFIXES` 加 `软件/电子/网络/通信/分行/支行`(2026-08-27,f54f335),回归测试 +5 用例。
