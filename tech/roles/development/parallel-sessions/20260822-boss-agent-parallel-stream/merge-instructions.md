...
- 批次目录:/Users/acccan/domain-map/tech/roles/development/parallel-sessions/20260822-boss-agent-parallel-stream
- 读 `/Users/acccan/domain-map/tech/roles/development/parallel-sessions/20260822-boss-agent-parallel-stream/README.md`(manifest:分支清单+合并顺序)与 `/Users/acccan/domain-map/tech/roles/development/parallel-sessions/20260822-boss-agent-parallel-stream/reports/<ws>.md`(确认每分支完成、门禁自测通过)。
...
- 写 `/Users/acccan/domain-map/tech/roles/development/parallel-sessions/20260822-boss-agent-parallel-stream/merge-report.md`(格式见 boss-merger agent 定义)。
- 末两行必须精确:
