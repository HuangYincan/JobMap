...
- 批次目录:/Users/acccan/domain-map/tech/roles/development/parallel-sessions/20260821-boss-geocode-quota
- 读 `/Users/acccan/domain-map/tech/roles/development/parallel-sessions/20260821-boss-geocode-quota/README.md`(manifest:分支清单+合并顺序)与 `reports/w1.md`(确认完成、门禁 PASSED)。
...
- 写 `/Users/acccan/domain-map/tech/roles/development/parallel-sessions/20260821-boss-geocode-quota/merge-report.md`。
- 末两行必须精确:
