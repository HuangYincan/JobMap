...
> git worktree add -b feature/national-db-schema ../dm-wt-ws1 dev
> cd ../dm-wt-ws1
> ```
> 之后所有开发/提交都在该 worktree 内完成;**不要在主工作树(dev)上直接改文件**。worktree 是本会话的独立工作区,其他并行会话(WS2/WS3/WS4)各有各的,互不干扰。完成后由你负责移除。
