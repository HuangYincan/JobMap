...
- 批次目录:/Users/acccan/domain-map/tech/roles/development/parallel-sessions/20260821-boss-geocode-count
- 读 `/Users/acccan/domain-map/tech/roles/development/parallel-sessions/20260821-boss-geocode-count/README.md`(manifest)与 `reports/w1.md`(确认完成、门禁 PASSED)。
...
- 写 `/Users/acccan/domain-map/tech/roles/development/parallel-sessions/20260821-boss-geocode-count/merge-report.md`。
- 末两行必须精确:
