...
- Mapper: `crawler/app/domain_map_importer/radar_jobs.py` (parser v1.2.0), run with `hangzhou_only` — 98 companies / 125 jobs.
- Regenerate: `make refresh-radar` (downloads + remaps + records SHA-256).
