...
- Mapper: `crawler/app/domain_map_importer/radar_jobs.py` (parser v1.1.0), run with `hangzhou_only` — 98 companies / 125 jobs.
- Regenerate: download the file, then `python3 -m domain_map_importer.cli radar --input jobs.json --out-dir ../server/data/recruitment/radar`.
